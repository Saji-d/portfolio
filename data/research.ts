...
export const researchPapers: ResearchStudy[] = [
  ...
  },
  {
    ...
    tags: ["HCI"],
    oneLiner:
      "A conceptual HCI framework that personalizes InteractOut-style input-friction interventions by user type, intent, and affect — grounded in the Transtheoretical Model and Self-Determination Theory.",
    summary:
      "Group paper (HCI assignment) that extends the CHI 2024 InteractOut concept. Instead of one-size-fits-all gesture friction, it adapts interventions to user type (light / moderate / heavy), implied intent (work vs. leisure), and perceived affect, using just-in-time adaptive intervention (JITAI) decision logic.",
    overview: [
      "Smartphone overuse is linked to poor sleep, anxiety, and distraction, and HCI interventions fall into two extremes: restrictive blocking, which frustrates users and encourages workarounds, or passive reminders, which are easily ignored.",
      "InteractOut (CHI 2024) showed that subtly slowing taps and swipes reduces usage while staying acceptable to users. This paper adapts that mechanism into a personalized, context-aware system.",
    ],
    problem: [
      "Existing interventions are one-size-fits-all — they ignore who the user is, what they are doing, and how they feel, so they either frustrate or fail.",
      "Blocking is too strict and reminders too lax; neither supports long-lasting habit change.",
    ],
    objective: [
      "Design a system that continuously monitors context and adjusts input-friction interventions through just-in-time regulation, adapted to user type, intent, and affect.",
      "Achieve better user experience through autonomy-supportive options and soft nudges, and more impact by accommodating a wider range of users.",
    ],
    methodology: [
      "Builds on InteractOut's friction mechanism and adds user modeling (light / moderate / heavy usage types).",
      "Infers implied intent (work vs. leisure) and perceived affect from context.",
      "Grounds intervention timing in health-behavior theory: the Transtheoretical Model (stages of change) and Self-Determination Theory (motivation).",
      "Presents conceptual system architecture and a JITAI decision flow.",
    ],
    models: [
      {
        name: "JITAI decision flow",
        role: "Just-in-time adaptive intervention logic that decides when and how strongly to apply friction.",
      },
      {
        name: "Transtheoretical Model + Self-Determination Theory",
        role: "Theory-grounded staging of habit change and autonomy-supportive motivation design.",
      },
    ],
    dataset: [
      "Conceptual design paper — no quantitative dataset; contributions are the system architecture, decision flow, and design rationale.",
    ],
    implementation: [
      "Delivered as a research paper with conceptual diagrams of the system architecture and the JITAI decision flow.",
      "Accompanied by a poster and a group presentation.",
    ],
    keyFeatures: [
      "Personalization by user type (light / moderate / heavy).",
      "Intent-aware and affect-aware intervention timing.",
      "Autonomy-supportive soft nudges instead of hard lockouts.",
      "Theory-grounded stages of change for long-lasting habit formation.",
    ],
    results: [],
    resultNotes: [
      "Conceptual contribution — the paper specifies the adaptive design but does not run an empirical field evaluation.",
    ],
    outcome: [
      "A design blueprint for adaptive digital-wellbeing interventions that respect user autonomy and fit real contexts.",
      "Positions input friction as a tunable, personalized mechanism rather than a blunt lockout.",
    ],
    tools: ["HCI design methods", "Presentation slides", "Poster"],
    challenges: [
      "Measuring intent and affect unobtrusively from phone usage.",
      "Calibrating friction so it nudges without frustrating.",
      "Avoiding user workarounds that undermine the intervention.",
    ],
    futureWork: [
      "Prototype implementation and a field study to measure usage reduction against the InteractOut baseline.",
      "Refine affect and intent inference with more context signals.",
    ],
    relatedSlugs: ["rm-paper", "neuronscreen"],
  },
  {
    slug: "rm-paper",
    ...
    tags: ["Research Methodology", "Survey Research"],
    oneLiner:
      "A structured-survey study of Bangladeshi youth (ages 18–35) that maps the barriers to entrepreneurship and recommends policy, education, and financing interventions.",
    summary:
      "Group research-methodology article investigating why entrepreneurship is increasingly necessary for Bangladeshi youth compared with traditional employment. Using a structured survey with descriptive analysis and cross-tabulation, it identifies key barriers — skills shortages, limited support systems, policy constraints, and cultural resistance — and proposes targeted interventions in education, financing, and policy.",
    metrics: [
      { value: "18–35", label: "respondent age range" },
      { value: "Survey", label: "structured instrument" },
      { value: "4", label: "authors" },
    ],
    overview: [
      "Bangladesh's formal job market cannot absorb its growing number of educated youth, making self-reliance and entrepreneurship increasingly necessary.",
      "This article studies what stands between Bangladeshi youth and entrepreneurship — and what interventions could remove those barriers.",
    ],
    problem: [
      "Youth unemployment and underemployment remain high despite economic growth, with limited formal jobs for graduates.",
      "Skills shortages, weak support systems, restrictive policy, and cultural resistance discourage youth from starting ventures.",
    ],
    objective: [
      "Investigate perceptions of self-reliance, innovation, and socio-economic support among Bangladeshi youth aged 18–35.",
      "Identify the barriers that make entrepreneurship essential yet difficult.",
      "Offer actionable recommendations for policymakers, educational institutions, and development agencies.",
    ],
    methodology: [
      "Structured survey instrument targeting Bangladeshi youth aged 18–35.",
      "Descriptive statistical analysis with cross-tabulation to relate perceptions and barriers across respondent groups.",
      "Findings synthesized into intervention areas across education, financing, and policy.",
    ],
    models: [
      {
        name: "Descriptive analysis + cross-tabulation",
        role: "Survey-based statistical method for summarizing perceptions and group differences.",
      },
    ],
    dataset: [
      "Structured survey responses from Bangladeshi youth aged 18–35 covering entrepreneurship perception, self-reliance, innovation, and socio-economic support.",
    ],
    implementation: [
      "Survey designed around the constructs of entrepreneurship, self-reliance, and innovation.",
      "Data analyzed with descriptive statistics and cross-tabulations; barriers grouped into themes.",
    ],
    keyFeatures: [
      "Evidence-based barrier mapping across four themes.",
      "Actionable recommendations for policy, education, and financing.",
      "Grounded in national and international literature on youth employment.",
    ],
    results: [],
    resultNotes: [
      "The primary findings identify skills shortages, limited support systems, policy constraints, and cultural resistance as the key barriers to youth entrepreneurship.",
    ],
    outcome: [
      "A practical roadmap for building an ecosystem where entrepreneurship can drive economic self-reliance and sustainable growth.",
    ],
    tools: ["Survey design", "Descriptive statistics", "Cross-tabulation"],
    challenges: [
      "Self-reported perceptions may not match economic reality.",
      "Sample coverage limited to reachable youth demographics.",
    ],
    futureWork: [
      "Expand to a larger, more representative national sample and add longitudinal tracking of entrepreneurial outcomes.",
      "Evaluate the impact of specific policy interventions over time.",
    ],
    relatedSlugs: ["interactout", "neuronscreen"],
  },
];
