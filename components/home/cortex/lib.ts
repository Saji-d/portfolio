  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tag: "project",
        card: "Team OpenGL city scene; I led animation: day/night, rain, snow, traffic light.",
    ...
    items: [
      {
        ...
        title: "CodingVibes",
        tag: "project",
        card: "Java Swing course storefront with logins, a cart and file-based storage.",
      ...
      },
      {
        ...
        tag: "project",
        card: "Employee registry with spouse/children records, search, and PDF exports.",
        tagline: pj("employee-family-registry").tagline,
        href: "https://github.com/Saji-d/employee-family-registry",
      },
      {
        id: "wedding",
