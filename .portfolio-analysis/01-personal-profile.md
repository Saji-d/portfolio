...
- **Full Name:** Sajidur Rahman Sajid
- **Location:** Dhaka, Bangladesh
- **Phone:** +8801954832959
- **Email:** sajidsajidurrahman99@gmail.com
- **GitHub:** https://github.com/Saji-d (username "Saji-d", bio: "💭 Learning > knowing", tagline "CSE student | Aspiring AI / ML Engineer", 2 followers, 1 following, Pro badge, 20 public repos, avatar = thought-cloud emoji)
- **LinkedIn:** https://www.linkedin.com/in/sajidur-rahman-sajid/
- **Facebook:** Sajidur.Rahman.SajiDD
- **University ID:** 22-49076-3

## Professional Summary (self-description, canonical)

> Software Engineer and AI/ML Developer with expertise in building high-throughput backend microservices, asynchronous distributed processing pipelines, and production machine learning models. Proficiency in Python (FastAPI, PyTorch), C# (.NET Core), JavaScript/TypeScript (Node.js, React, Next.js), SQL, PostgreSQL with Row-Level Security (RLS). Experienced in architecting SOC 2 Type II compliant backend systems, building Redis Streams backed task queues, fine-tuning domain-specific transformer models (FinBERT), and engineering hybrid ML/DL ensemble systems. BSc CSE from AIUB, 3.92/4.00 CGPA, 5x Dean's Honor Awards, Duke of Edinburgh's Gold Award.

## Target Roles
Software Engineer | Backend Engineer | Python Developer | AI Engineer | Machine Learning Engineer
...
- **Personal (never public):** E:\SAJID (NIDs, passports, BRC, financial statements, police reports), E:\NIDs on X, E:\SAJID weds Dilruba albums, E:\Movie, E:\Horror, drive-download RAW photos, E:\Untitled (movie segments).
