...
| File | Contents |
| :--- | :--- |
| `README.md` | This index + scanning methodology |
| `01-personal-profile.md` | Everything learned about the person |
| `02-career-timeline.md` | Chronological career & academic timeline |
| `03-project-inventory.md` | Complete project-by-project inventory (name, purpose, stack, architecture, status, complexity, feature-worthiness) |
| `04-technical-stack-matrix.md` | Tech stack per project, skills inventory |
| `05-research-and-thesis.md` | Thesis + research papers summaries |
| `06-awards-certifications.md` | Awards, honors, certificates, certifications |
| `07-repository-inventory.md` | Git repo inventory (remotes, branches, commit counts, visibility) |
| `08-assets-index.md` | Screenshots, demos, images, logos, media index |
| `09-ideas-and-pitchdecks.md` | IDEAS folder, pitch decks, product concepts |
| `10-career-docs.md` | CV/resume extracted info, references, links |
| `11-final-report.md` | The comprehensive final report (what to highlight, what to hide, branding, differentiation) |
